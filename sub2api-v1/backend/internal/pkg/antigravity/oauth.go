...
const (
	...
	// Antigravity OAuth client id is intentionally not embedded in this repository.
	ClientID = ""

	// AntigravityOAuthClientIDEnv is the Antigravity OAuth client_id environment variable name.
...
// defaultClientID/defaultClientSecret 可通过环境变量覆盖。
var defaultClientID = ""
