...
func (h *OpenAIHandler) Models(c *gin.Context) {
	data := []modelItem{
		{ID: "gpt-5.5", Object: "model", OwnedBy: "cockpit", Kind: "text", Endpoint: "/v1/chat/completions"},
		{ID: "gpt-5.3-codex", Object: "model", OwnedBy: "cockpit", Kind: "text", Endpoint: "/v1/chat/completions"},
		{ID: "gpt-5.3-codex-spark", Object: "model", OwnedBy: "cockpit", Kind: "text", Endpoint: "/v1/chat/completions"},
		{ID: "gpt-5.2", Object: "model", OwnedBy: "cockpit", Kind: "text", Endpoint: "/v1/chat/completions"},
